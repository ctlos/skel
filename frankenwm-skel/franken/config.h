...
#define FOCUS           "#798BC7" /* focused window border color   */
...
static const AppRule rules[] = { \
    ...
    { "Telegram",         0,       False,   False, -1 },
    { "Chromium",         1,       False,   False, 0 },
    { "Firefox",          1,       False,   False, 0 },
    { "GNU Image",        -1,      False,   True, 0 },
    { "Sublime Text",     2,       False,   False, -1 },
};
...
static key keys[] = {
    ...
    {  MOD1,             XK_Tab,        next_win,          {.i = +1}},
    {  MOD1|SHIFT,       XK_Tab,        prev_win,          {.i = -1}},
